...
- [`background`](../styles/background.md) - Background color property
- [`background-tint`](../styles/background_tint.md) - Background tint property
- [`border`](../styles/border.md) - Border style property
- [`border-title-background`](../styles/border_title_background.md) - Border title background property
- [`border-title-color`](../styles/border_title_color.md) - Border title color property
- [`border-subtitle-background`](../styles/border_subtitle_background.md) - Border subtitle background property
- [`border-subtitle-color`](../styles/border_subtitle_color.md) - Border subtitle color property
- [`color`](../styles/color.md) - Text color property
- [`hatch`](../styles/hatch.md) - Hatch style property
- [`keyline`](../styles/keyline.md) - Keyline style property
- [`link-background`](../styles/links/link_background.md) - Link background color property
- [`link-background-hover`](../styles/links/link_background_hover.md) - Link background hover color property
- [`link-color`](../styles/links/link_color.md) - Link text color property
- [`link-color-hover`](../styles/links/link_color_hover.md) - Link text hover color property
- [`outline`](../styles/outline.md) - Outline style property
- [`scrollbar-background`](../styles/scrollbar_colors/scrollbar_background.md) - Scrollbar background color property
- [`scrollbar-background-active`](../styles/scrollbar_colors/scrollbar_background_active.md) - Scrollbar background active color property
- [`scrollbar-background-hover`](../styles/scrollbar_colors/scrollbar_background_hover.md) - Scrollbar background hover color property
- [`scrollbar-color`](../styles/scrollbar_colors/scrollbar_color.md) - Scrollbar color property
- [`scrollbar-color-active`](../styles/scrollbar_colors/scrollbar_color_active.md) - Scrollbar active color property
- [`scrollbar-color-hover`](../styles/scrollbar_colors/scrollbar_color_hover.md) - Scrollbar hover color property
- [`scrollbar-corner-color`](../styles/scrollbar_colors/scrollbar_corner_color.md) - Scrollbar corner color property
- [`tint`](../styles/tint.md) - Tint style property
