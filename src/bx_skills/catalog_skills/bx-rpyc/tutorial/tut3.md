...
```
>>> c.root.get_answer() 42 >>> c.root.the_real_answer_though 43
```

Meanwhile, the question is not exposed:

```
>>> c.root.get_question() ======= Remote traceback ======= ... File "/home/tomer/workspace/rpyc/core/protocol.py", line 298, in sync_request raise obj AttributeError: cannot access 'get_question'
```
