...
Also note that if you are using classic mode RPyC, you can use the [context manager](https://docs.python.org/3/library/stdtypes.html#typecontextmanager) `rpyc.classic.redirected_stdio`:
