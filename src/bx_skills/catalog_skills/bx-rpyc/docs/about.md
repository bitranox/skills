...
RPyC was inspired by the work of **Eyal Lotem** on [pyinvoke](https://pybuild.sourceforge.net/pyinvoke.html), which pioneered in the field of "dynamic RPC" (where there's no predefined contract between the two sides). The two projects, however, are completely unrelated in any other way. RPyC is developed and maintained by [Tomer Filiba](https://tomerfiliba.com/) (<tomerfiliba@gmail.com>).
